        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserNotificationPreferences_NotificationCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "NotificationCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserNotificationPreferences_NotificationCategories_CategoryId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Notifications_NotificationTopics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserNotificationSubscriptions_NotificationTopics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "NotificationTopics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "NotificationChannelStatuses",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationChannelStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotificationChannelStatuses_UserNotifications_UserNotificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationChannelStatuses_UserNotificationId_Channel",
                table: "NotificationChannelStatuses",
                columns: new[] { "UserNotificationId", "Channel" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTopics_Name",
                table: "NotificationTopics",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationPreferences_CategoryId",
                table: "UserNotificationPreferences",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationPreferences_CategoryId1",
                table: "UserNotificationPreferences",
                column: "CategoryId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationPreferences_UserId_CategoryId_Channel",
                table: "UserNotificationPreferences",
                columns: new[] { "UserId", "CategoryId", "Channel" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationSubscriptions_TopicId",
                table: "UserNotificationSubscriptions",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationSubscriptions_UserId_TopicId",
                table: "UserNotificationSubscriptions",
